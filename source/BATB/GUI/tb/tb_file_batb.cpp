...
TBFile *TBFile::Open(const char *filename, TBFileMode mode)
{
        ...
        //if ( auto path = strip_protocol( "static://"  , filename ) ) { std::cout << "TBFile::Open(): path: " << file::static_data( path ) << std::endl; return TBFileBATB::OpenImpl( file::static_data( path ).c_str(),  mode ); }
        //if ( auto path = strip_protocol( "dynamic://" , filename ) ) { std::cout << "TBFile::Open(): path: " << file::dynamic_data( path ) << std::endl; return TBFileBATB::OpenImpl( file::dynamic_data( path ).c_str(), mode ); }
        //if ( auto path = strip_protocol( "user://"    , filename ) ) { std::cout << "TBFile::Open(): path: " << file::user_data( path ) << std::endl; return TBFileBATB::OpenImpl( file::user( path ).c_str(),         mode ); }
